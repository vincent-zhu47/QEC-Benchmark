...
if not get_from_file:
    ...
    latencies = np.empty(shape=1000000)
    ...
    for i in range(1000000) :
        ...
        hyperion, hyperion_subgraph, latency = run_mwpf(mwpf_hypergraph, num_vertices, defect_measurement_indices, 1)
        latencies[i] = latency
